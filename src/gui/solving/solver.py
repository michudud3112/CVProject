...
class solver:
    ...
    def make_a_daisy(self):
        ...
        self.cube.solution += "Solving the daisy: "
        for i in range(4):
    ...
    def find_and_insert_f2l(self, colors):
        ...
        self.cube.solution += "Looking for F2L piece in top layer: "
        found_piece = False
    ...
    def remove_f2l_from_wrong_slot(self, colors):
        ...
        self.cube.solution += "Removing from wrong slot: "
        removed = False
        count = 0
    ...
    def adjust_cross(self):
        ...
        # check if this step is necessary
        checks = 0
        #self.cube.solution += "Checking if it's already aligned: "
        while checks < 4:
            ...
            self.cube.U()
            checks += 1
        #self.cube.solution += "Aligning for algorithm: "
        aligned = False
        count = 0
        while not aligned:
            count += 1
